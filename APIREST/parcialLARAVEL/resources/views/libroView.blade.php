...
<h1 style="color: red; font-family:'Courier New', Courier, monospace; font-weight:bolder">MODIFICAR LIBRO</h1>
<br>
<div>
...
<div>
    ...
    <input type="text" style="height: 30px;" name="title" id="title" placeholder="100 años de soledad" value="{{ $book['title'] }}">
</div>
<br><br>
<div>
    <label style="font-size: 40px; font-weight: bold;">DESCRIPCIÓN:</label>
    <input type="text" style="height: 30px; width:202px" name="description" id="description" placeholder="Es muy interesante por..." value="{{ $book['description'] }}">
</div>
<br><br>
<div>
    <label style="font-size: 40px; font-weight: bold;">AUTOR:</label>
    <input style="height: 30px; width: 200px" type="text" name="author" id="author" placeholder="Gabriel Garcia Marquez" value="{{ $book['author'] }}">
</div>
...
<br><br>
<button onclick="return eliminar()" type="submit" style="font-size: 40px; font-weight: bold;">MODIFICAR</button>
</form>  
@endforeach
...
<script>
    function eliminar(){
       var respuesta=confirm("Estas seguro que deseas actualizar este registro?")
       return respuesta
     }
</script>
</body>
